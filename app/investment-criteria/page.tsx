...
const PARAMETERS = [
  { value: "$2M–$20M", label: "Target EBITDA" },
...
const CRITERIA = [
  ...
  },
  {
    ...
    tagline: "$2M–$20M in EBITDA with clean financials.",
    desc: "We target businesses generating $2M–$20M in EBITDA. Clean books, no surprises. Financial clarity is the foundation of a good deal.",
  },
  {
    num: "04",
